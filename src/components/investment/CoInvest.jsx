...
const InvestInnerCard = ({ invest, isOpen, toggleCard }) => {
  ...
  return (
    <div key={invest.id}>
      <div
        onMouseEnter={() => toggleCard(invest.id)}
        onMouseLeave={() => toggleCard(invest.id)}
...
const CoInvest = () => {
  ...
  const investments = [
    ...
    },
    {
      ...
      link: "",
      imgURL: client11,
      bio: "Tongston provided US$3k grants as part of the Top 3 prizes to the TEES 2023 Entrepreneurial Pitches Prize Winners. ",
    },
    {
      id: 8,
      name: "CUPMENA",
      link: "",
      imgURL: client10,
      bio: "Tongston provided US$2k grants as part of the Top 3 prizes to the TEES 2023 Entrepreneurial Pitches Prize Winners. ",
    },
    {
      id: 9,
      name: "PROVEIT",
      link: "",
      imgURL: client12,
      bio: "Tongston provided US$1k grants as part of the Top 3 prizes to the TEES 2023 Entrepreneurial Pitches Prize Winners. ",
    },
  ];
