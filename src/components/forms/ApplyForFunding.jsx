      ...
      <div className="form-container fixed inset-0 z-50 flex items-center justify-center bg-transparent">
        ...
        >
          <div className="iframe-container sm:w-full sm:h-[300px]   sm:ml-[4rem] sm:mr-[4rem]            md:w-full md:h-[400px] ">
            <iframe
              src="https://docs.google.com/forms/d/e/1FAIpQLSdmI9yld2bqYhjCoffcJWBFbgYt949BQFCY5GOulPEOdrVYew/viewform?embedded=true"
              width="400"
              height="434"
              frameborder="0"
              marginheight="0"
          ...
          <p className="text-black font-sans font-bold text-base relative mt-auto md:mt-auto   md:text-2xl">
            {currentDate.toLocaleString()}
          </p>
          <button
            onClick={() => onClose()}
