      ...
      <div className="form-container fixed inset-0 z-50 flex items-center justify-center bg-transparent">
        ...
        >
          ...
          <form
            ...
            className="form-inputs flex flex-row flex-wrap  justify-center items-center gap-6 h-40 overflow-y-auto  md:h-full"
          >
            <input
            ...
            <select
              ...
              className="outline-none h-[25px] rounded-lg  border-gold border-0 border-b w-[45%] mr-auto"
            >
              <option value="" disabled>
                {" "}
              ...
              <option value="	Provide financing facilities   including grants to Tongston Clientele  	">
                {" "}
                Provide financing facilities including grants to Tongston
                Clientele
              </option>
              ...
              <option value="	Provide in-kind sponsorships on Technological services   	">
                {" "}
                Provide in-kind sponsorships on Technological services
              </option>
              <option value="provide in-kind Sponsorships on  Financial services   ">
                provide in-kind Sponsorships on Financial services
              </option>
              <option value="Provide in-kind sponsorships on Marketing & communications">
                Provide in-kind sponsorships on Marketing & communications
              </option>
              <option value="Provide in-kind Sponsorships on Branding">
                Provide in-kind Sponsorships on Branding
              </option>
              <option value="Provide in-kind Sponsorships on  Accounting & Audit Services">
                Provide in-kind Sponsorships on Accounting & Audit Services
              </option>
              <option value="Provide in-kind Sponsorships on Legal services  ">
                Provide in-kind Sponsorships on Legal services
              </option>
              <option value="Provide in-kind Sponsorships on Data & Research services">
                Provide in-kind Sponsorships on Data & Research services
              </option>
