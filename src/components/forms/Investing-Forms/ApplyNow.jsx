...
const ApplyNow = ({ onClose }) => {
  ...
  return (
    ...
    //         <iframe
    //           src="https://docs.google.com/forms/d/e/1FAIpQLSdbr_74v7tEdcDdOyFXJIElSKUs6_QrhNvFIQcnhPyFrcDqQg/viewform?embedded=true"
    //           width="400"
    //           height="434"
    //           frameborder="0"
    //           marginheight="0"
    ...
    //       {/* <p className="text-black font-sans font-bold text-base relative mt-auto   md:text-2xl">
    //         {currentDate.toLocaleString()}
    //       </p> */}
    //       <button
    //         onClick={() => onClose()}
    ...
    <>
      <div className="form-container fixed inset-0 z-50 flex items-center justify-center bg-transparent">
        ...
        >
          <button
            onClick={() => onClose()}
            className="hidden text-3xl absolute top-0 right-0 p-2 py-2 mx-2 bg-red text-white hover:text-black rounded-[50%] w-10 justify-center items-center md:flex "
          >
            <FontAwesomeIcon icon={faTimes} times-icon className="w-[70px]" />
          </button>

          <div className="iframe-container sm:w-full sm:h-[300px] sm:ml-[4rem] sm:mr-[4rem] md:w-full md:h-[450px]">
            <iframe
              src="https://docs.google.com/forms/d/e/1FAIpQLSdbr_74v7tEdcDdOyFXJIElSKUs6_QrhNvFIQcnhPyFrcDqQg/viewform?embedded=true"
              width="400"
              height="434"
          ...
          <button
            onClick={() => onClose()}
            className="  text-3xl top-0 right-0 p-2 py-2 mx-2 bg-red text-white   hover:text-black  rounded-[50%] w-10    justify-center items-center flex md:hidden "
          >
            <FontAwesomeIcon icon={faTimes} times-icon className="w-[70px]" />
          </button>
        </div>
