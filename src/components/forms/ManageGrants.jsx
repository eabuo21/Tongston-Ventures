        ...
        >
          ...
          >
            ...
            <div className="flex flex-col gap-3 justify-center items-center">
              ...
              <button
                className={` 
                }submit-button bg-red text-white rounded w-[300px] h-[50px] hover:bg-gold hover:text-white hover:transition-all ease-in-out hover:duration-1000 transition-all  duration-1000 ${
                  !checked &&
                  "cursor-not-allowed opacity-50 hover:bg-red hover:opacity-50"
                } `}
                type="submit"
                disabled={!checked}
              >
                {loading ? (
                  <b className="animate-pulse"> Processing...</b>
                ) : (
                  <b> Proceed </b>
                )}
              </button>
