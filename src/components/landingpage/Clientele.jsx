...
import Client10 from "../../assets/images/clientel/client10.png";
import Client11 from "../../assets/images/clientel/client11.png";
import Client12 from "../../assets/images/clientel/client12.png";
import Client13 from "../../assets/images/clientel/client13.png";
import Client14 from "../../assets/images/clientel/client14.png";
import Client15 from "../../assets/images/clientel/client15.png";
        ...
        <div className="images-expressions flex flex-col px-1 py-1 justify-center items-center lg:flex-row lg:justify-normal lg:items-center       md:flex-row md:justify-normal md:items-center">
          ...
          >
            <img
              src={Client1}
              alt="client-1"
              className="   px-1 py-1 w-[100px] h-[105px]   rounded-md bg-gray-100 shadow-currents         md:hover:bg-primary_yellow     md:transition-all   md:ease-in-out   md:hover:ease-in-out    md:hover:duration-700  duration-700         lg:py-4  lg:px-1  lg:w-[150px]                 md:py-4  md:w-[150px]"
            />
            <img
              src={Client2}
              alt="client-2"
              className="   px-1 py-1 w-[100px] h-[105px] object-contain rounded-md  bg-gray-100 shadow-currents         md:hover:bg-primary_yellow     md:transition-all   md:ease-in-out   md:hover:ease-in-out    md:hover:duration-700  duration-700            lg:py-4  lg:px-1  lg:w-[150px]                 md:py-4 md:w-[150px] "
            />
            <img
              src={Client3}
              alt="client-3"
