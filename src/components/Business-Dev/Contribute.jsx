...
const Portfolio = () => {
  ...
  const BizPort = [
    ...
    },
    {
      ...
      link: "",
      imgURL: client13,
      bio: "Tongston provided business advisory services as part of the Gombe State University IDEAS Contest.",
    },
    {
      id: 8,
      name: "COMET CUBES",
    ...
    },
    {
      ...
      link: "",
      imgURL: client11,
      bio: "Tongston provided business advisory services as part of the Top 3 prizes to the TEES 2023 Entrepreneurial Pitches Prize Winners.",
    },
    {
      id: 11,
      name: "CUPMENA",
